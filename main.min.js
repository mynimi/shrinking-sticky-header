...
$(document).ready(function(){$("nav img").css("height",$("nav img").height()),$("nav .container").css("height",$(".menu").outerHeight()),$("nav").stickyNav(),$(window).scroll(function(){$(window).scrollTop()>$("nav img").offset().top?$("nav img").addClass("small"):$("nav img").removeClass("small")})});
